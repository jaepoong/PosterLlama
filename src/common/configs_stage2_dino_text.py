...
def get_config():
    ...
    config.train_json = "data/cgl_dataset/for_posternuwa/html_format_img_instruct_mask_all_condition_text/train_llama_numerical.jsonl"
    config.val_json = "data/cgl_dataset/for_posternuwa/html_format_img_instruct_mask_all_condition_text/val_llama_numerical.jsonl"
    ...
    config.stage1_model = "log_dir/train_stage1_dino/checkpoints/checkpoint-18/pytorch_model.bin"
