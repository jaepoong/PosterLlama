...
def get_config():
    ...
    # Exp info
    config.train_json = "data/PKU_PosterLayout/for_posternuwa/html_format_img_instruct_all_mask_and_all_condition/train_llama_numerical.jsonl"
    config.val_json = "data/PKU_PosterLayout/for_posternuwa/html_format_img_instruct_all_mask_and_all_condition/val_llama_numerical.jsonl"
    config.train_img_path ="data/PKU_PosterLayout/train/inpainted_poster"
    config.val_img_path = "data/PKU_PosterLayout/train/inpainted_poster"
